...
export const Header = () => {
    ...
    return (
        <div className="bg-primary">
            <div className=" h-20 text-white flex justify-between items-center px-4 mx-auto lg:containers">

                <IoMenu type="button" onClick={showMenu} className="h-12 w-12 md:h-20 md:w-20" />
                ...
                <form className="relative w-full m-2 max-w-[600px]">
                    <input id='search' type="text" className="text-black px-3 rounded-full h-8 outline-none w-full lg:h-10" />
                    <IoIosSearch className="text-black w-6 h-6 absolute top-1 right-2  lg:h-9 lg:w-9" />
                </form>
